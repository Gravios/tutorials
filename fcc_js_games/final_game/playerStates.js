...
export class Sitting extends State {
    ...
    handleInput(input){
        ...
        else if (input.includes(' '))                                      this.game.player.setState(states.ROLLING, 1);
    }
}
...
export class Rolling extends State {
    ...
    handleInput(input){
        ...
        else if ( input.includes(' ') && input.includes('ArrowUp') && this.game.player.onGround())   this.game.player.vy = -30; 
...
export class Diving extends State {
    ...
    handleInput(input){
        ...
        } else if ( input.includes(' ') && this.game.player.onGround())   this.game.player.setState(states.ROLLING, 2);
    }
} 
